...
extern  st7735_info_t st7735_init_info;
...
void tft_init(void)
{
	...
	bsp_lcd_init();
	draw_buf1 = (lv_color_t*)st7735_bsp_get_draw_buffer1_addr();
	draw_buf2 = (lv_color_t*)st7735_bsp_get_draw_buffer2_addr();
	...
	disp_drv.user_data = (void*)&st7735_init_info;
...
static void tft_flush(lv_disp_drv_t * drv, const lv_area_t * area, lv_color_t * color_p)
{
	...
	st7735_info_t *hlcd = (st7735_info_t*)drv->user_data;
    ...
    display_area_t area_st7735;
    area_st7735.x0 = act_x1;
    area_st7735.x1 = act_x2;
    area_st7735.y0 = act_y1;
    area_st7735.y1 = act_y2;

	st7735_bsp_set_display_area(area_st7735);
...
/**
  ...
  * @retval None
  */
void DMA_TransferComplete(st7735_info_t *hlcd)
{
	 lv_disp_flush_ready(&disp_drv);
#if 0
	y_fill_act ++;
...
/**
  ...
  * @retval None
  */
 void DMA_TransferError(st7735_info_t *hlcd)
{
